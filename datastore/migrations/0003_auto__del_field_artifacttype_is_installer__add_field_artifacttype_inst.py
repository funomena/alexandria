...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArtifactType.is_installer'
        db.delete_column(u'datastore_artifacttype', 'is_installer')

        # Adding field 'ArtifactType.installer_type'
        db.add_column(u'datastore_artifacttype', 'installer_type',
                      self.gf('django.db.models.fields.CharField')(default='NOT INSTALLER', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ArtifactType.is_installer'
        db.add_column(u'datastore_artifacttype', 'is_installer',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ArtifactType.installer_type'
        db.delete_column(u'datastore_artifacttype', 'installer_type')
