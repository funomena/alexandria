...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'datastore_build', 'name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Build.name'
        db.alter_column(u'datastore_build', 'name', self.gf('django.db.models.fields.CharField')(default='OLD NAME', max_length=128))
